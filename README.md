...
В проекте используется инструмент для анализа данных о покрыти кода `unit-тестами`, сгенерированных компилятором `GCC`: [**lcov**](https://github.com/linux-test-project/lcov).
